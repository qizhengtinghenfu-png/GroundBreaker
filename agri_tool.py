...
if menu == "📄 1. 文献快速解析":
    ...
    if uploaded_pdf is not None:
        ...
        with c1:
            if st.button("🐣 生成小白版总结", use_container_width=True): d_txt, a_pmt = "帮我生成小白版总结！", "你是一位幽默风趣的农学科普大V。解读这篇文献：1.核心故事 2.用的绝招 3.还有啥坑没填。多用比喻，生动接地气。"
        with c2:
            if st.button("🔬 生成专家版总结", use_container_width=True): d_txt, a_pmt = "帮我生成专家版总结！", "作为严谨审稿人提炼：1.一句话核心发现 2.关键数据支撑 3.创新壁垒 4.潜在缺陷。严禁废话。"
        with c3:
